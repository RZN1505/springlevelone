...
@EnableWebMvc
@ComponentScan("pro.bolshakov.geekbrains.dz2")
@Configuration
@EnableJpaRepositories("pro.bolshakov.geekbrains.dz2.repository")
...
public class AppConfig implements WebMvcConfigurer {
   ...
   @Bean
    ...
    public LocalContainerEntityManagerFactoryBean getEntityManager() {
        ...
        factory.setPackagesToScan("pro.bolshakov.geekbrains.dz2.domain");
